...
export default function VariableManager() {
    ...
    const [sortBy, setSortBy] = useState<"name" | "category" | "data_source">("name");
                            ...
                            {sortedVariables.map((variable) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 px-3 uppercase">{variable.data_source}</td>
                                        <td className="py-2 px-3">{variable.acs_variable ?? "—"}</td>
                                        <td className="py-2 px-3">{variable.gis_table ?? "—"}</td>
                                        <td className="py-2 px-3">{variable.catalog_table ?? "—"}</td>
                                            ...
                                            {isEditable ? (
                                                <div className="flex items-center justify-center gap-2">
                                                    <IconButton
                                                        ...
                                                        icon={<Pencil size={16} className="text-dvrpc-blue-3" />}
                                                    />
                                                    <IconButton
                                                ...
                                                <span className="text-xs text-dvrpc-gray-2">View only</span>
                                            )}
                                        </td>
                                    </tr>
                                );
