...
const primaryColors =
  "bg-dvrpc-blue-1 hover:bg-dvrpc-blue-3 text-white focus:ring-dvrpc-blue-5";
const secondaryColors =
  "bg-dvrpc-gray-7 hover:bg-dvrpc-gray-6 text-dvrpc-gray-1  focus:ring-dvrpc-gray-5 ";
